...
decl_list %= idx + colon + typex + assign + expr + comma + decl_list, lambda h,s: [LetDeclarationNode(s[1], s[3], s[5])] + s[7]
decl_list %= idx + colon + typex + comma + decl_list, lambda h,s: [LetDeclarationNode(s[1], s[3], None)] + s[5]
decl_list %= idx + colon + typex + assign + expr, lambda h,s: [LetDeclarationNode(s[1], s[3], s[5])]
decl_list %= idx + colon + typex, lambda h,s: [LetDeclarationNode(s[1], s[3], None)]
